...
(() => {
    ...
    reloadTaskBtn.addEventListener('click', () => {
        ...
        //         changeStylesAndAppend(dragElemContainer, elem.firstElementChild);
        //     }
        // });
        let dragElem = mapContainer.querySelectorAll('.dragElem');
        dragElem.forEach((elem) => {
            elem.style.top = `${elem.parentElement.offsetTop}px`;
            elem.style.left = `${elem.parentElement.offsetLeft}px`;
